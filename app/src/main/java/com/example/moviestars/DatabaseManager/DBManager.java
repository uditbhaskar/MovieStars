package com.example.moviestars.DatabaseManager;
...
public class DBManager {
    String dbname = "FavMovieStars";
    String dbTable = "List";
    String colId = "_id";
    String colMovieId = "colMovieId";
    ...
    String sqlCreateTable = "CREATE TABLE IF NOT EXISTS "+dbTable+" ("+ colId +" INTEGER PRIMARY KEY, "+
            colMovieId + " TEXT, "+ colFirstName +" TEXT, "+ colLastName+ " TEXT, "+ colMovieName+ " TEXT, "+ colTime+ " TEXT, "+ colImage+ " TEXT);";
